...
<div class="flex bg-slate-800 p-8">
  <div class="inline-block text-4xl font-bold">Gradient text is awesome!</div>
</div>
...
<div class="flex bg-slate-800 p-8">
  <div class="inline-block bg-gradient-to-r from-rose-500 via-pink-500 to-orange-400 text-4xl font-bold">
...
<div class="flex bg-slate-800 p-8">
  <div class="inline-block bg-gradient-to-r from-rose-500 via-pink-500 to-orange-400 text-4xl font-bold text-transparent">
    Gradient text is awesome!
  </div>
</div>
...
<div class="flex bg-slate-800 p-8">
  <div class="inline-block bg-gradient-to-r from-rose-500 via-pink-500 to-orange-400 bg-clip-text text-4xl font-bold text-transparent">
    Gradient text is awesome!
  </div>
</div>
...
<div class="flex bg-slate-800 p-8">
  <div class="inline-block bg-gradient-to-r from-rose-500 via-pink-500 to-orange-400 bg-[length:200%] bg-clip-text text-4xl font-bold text-transparent">
    Gradient text is awesome!
  </div>
</div>
...
<div class="flex bg-slate-800 p-8">
  <div class="inline-block bg-gradient-to-r from-rose-500 via-pink-500 to-orange-400 bg-[length:200%] bg-clip-text bg-right text-4xl font-bold text-transparent">
    Gradient text is awesome!
  </div>
</div>
...
<div class="flex bg-slate-800 p-8">
  <div class="inline-block animate-backAndForth bg-gradient-to-r from-rose-500 via-pink-500 to-orange-400 bg-[length:200%] bg-clip-text text-4xl font-bold text-transparent">
    Gradient text is awesome!
  </div>
</div>
